# koklyp — architektura v1 (řešení + kontrakty)

Konkrétní kontrakty implementované ve verzi v1. Zatímco dokument [`koklyp-architecture.md`](koklyp-architecture.md) slouží jako obecný plán, tento dokument představuje **schéma zapojení** — rozhraní, schémata, životní cykly a taxonomie chyb.
